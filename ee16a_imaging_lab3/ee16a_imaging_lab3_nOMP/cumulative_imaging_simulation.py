...
class Mask(QtWidgets.QWidget):
  def __init__(self, imgWidth, imgHeight, infile, imagefile, outfile, sleepTime):
...
def main():
  ...
  parser.add_argument('--mask', default = "H.npy", help = 'saved sampling pattern mask (default = "H.npy")')
  parser.add_argument('--image', default = "Home.png", help = 'saved image (default = "Home.png")')
  parser.add_argument('--out', default = "sensor_readings_H", help = 'output path (default="sensor_readings_H", saved as "sensor_readings_H.npy")')
  ...
  mask = Mask(args.width, args.height, args.mask, args.image, args.out, args.sleepTime)
